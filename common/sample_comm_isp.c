...
//added by lewis
static ot_isp_pub_attr g_isp_pub_attr_imx347_slave_mipi_1080P_30fps = {
    {0, 20, FHD_WIDTH, FHD_HEIGHT},
...
td_s32 sample_comm_isp_get_pub_attr_by_sns(sample_sns_type sns_type, ot_isp_pub_attr *pub_attr)
{
    switch (sns_type) {
        ...
        case SONY_IMX347_SLAVE_MIPI_1080P_30FPS_12BIT:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx347_slave_mipi_1080P_30fps, sizeof(ot_isp_pub_attr));//2lane
            break;
