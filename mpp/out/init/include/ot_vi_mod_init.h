...
td_u32 vi_get_vicap_ip_num(td_void);
td_void vi_set_vicap_base_addr(td_u32 vicap_id, const td_void *base_addr);
td_void vi_set_vicap_irq_num(td_u32 vicap_id, td_u32 irq_num);

td_u32 vi_get_viproc_ip_num(td_void);
td_void vi_set_viproc_base_addr(td_u32 viproc_id, const td_void *base_addr);
td_void vi_set_viproc_irq_num(td_u32 viproc_id, td_u32 irq_num);
