...
#define VGS_DEFAULT_JOB_NUM 128
#define VGS_DEFAULT_TASK_NUM 200
#define VGS_DEFAULT_NODE_NUM 200

static unsigned int g_max_vgs_job = VGS_DEFAULT_JOB_NUM;
static unsigned int g_max_vgs_task = VGS_DEFAULT_TASK_NUM;
static unsigned int g_max_vgs_node = VGS_DEFAULT_NODE_NUM;
